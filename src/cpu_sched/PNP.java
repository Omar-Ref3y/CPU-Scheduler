...
public class PNP extends javax.swing.JFrame {
    ...
    public PNP() {
        ...
        this.setTitle("CPU Schedulling(PNP)");
    ...
    private void initComponents() {
        ...
        FCFS_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Arrival Time", "Priority", "Waiting Time", "Turn Around Time"
            }
        ) {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 227, 520, 330));
        ...
        jPanel1.add(Add_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 390, 130, 40));
        ...
        jPanel1.add(calc_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 390, 130, 40));
        ...
        jPanel1.add(Del_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, 100, 40));
        jPanel1.add(P_Field, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 170, 30));
        ...
        jLabel2.setText("Priority Non Preemptive");
        ...
        jPanel1.add(ATAT_Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 540, 150, 30));

        AT.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        AT.setForeground(new java.awt.Color(108, 18, 173));
        AT.setLabelFor(AT_Field);
        AT.setText("Arrival Time");
        jPanel1.add(AT, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, -1, -1));

        Priority.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        Priority.setForeground(new java.awt.Color(108, 18, 173));
        Priority.setLabelFor(P_Field);
        Priority.setText("Priority");
        jPanel1.add(Priority, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, -1, -1));

        AWT_Label.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jPanel1.add(AWT_Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 490, 150, 30));
        ...
        P_ID1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        P_ID1.setForeground(new java.awt.Color(108, 18, 173));
        P_ID1.setLabelFor(P_ID_Field);
        P_ID1.setText("Prosess ID");
        jPanel1.add(P_ID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, -1, -1));

        S_O_P.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        S_O_P.setForeground(new java.awt.Color(255, 0, 0));
        jPanel1.add(S_O_P, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 165, 120, 40));
        ...
        jPanel1.add(SOF_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 170, -1, -1));
    ...
    private void calc_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calc_btnActionPerformed
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            row[2] = Integer.parseInt(String.valueOf(model.getValueAt(i, 2)));
            row[3] = 0;
            row[4] = 0;
            TableData.add(row);
        }
    ...
    private void Add_To_Table() {
        ...
        try {
            ...
            int Priority = Integer.parseInt(P_Field.getText());
            String ProcessID = P_ID_Field.getText();
            if (!ProcessID.isEmpty()) {
                DefaultTableModel model = (DefaultTableModel) FCFS_Table.getModel();
                Object[] row = {"P" + ProcessID, ArrivalTime, Priority, 0, 0};
                model.addRow(row);
                Clear_CPU_Time();
    ...
    private void Show_Answer() {
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            T_W += Integer.parseInt(String.valueOf(model.getValueAt(i, 3)));
            T_W_T += Integer.parseInt(String.valueOf(model.getValueAt(i, 4)));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PNP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
